...
This assumes you already [have your own APKs](/projects/bl0wfl3x/backup). Note that even though I'm specifying this on Nautilus' apps, this applies to pretty much any Android application you'd like to "peek under the hood".
