...
import ProjectImage from "@/assets/images/project-fl3xbl0w.png";

export const title = "Android Jailbreak - fl3xbl0w";
...
![logitech k600 keyboard](/assets/images/fl3xbl0w/logi-keys.png) 
...
![console usb location](/assets/images/fl3xbl0w/console-usb.png) 


Let's make sure the keyboard works by clicking the "Home" button on the keyboard. It should cause the JRNY app to restart.
<img src="/assets/images/fl3xbl0w/console-01.gif" alt="console animation" format="avif" />
...
<img src="/assets/images/fl3xbl0w/console-02.gif" alt="console animation" format="avif" />
...
<img src="/assets/images/fl3xbl0w/console-03.gif" alt="console animation" format="avif" />
...
<img src="/assets/images/fl3xbl0w/console-04.gif" alt="console animation" format="avif" />

Find the Console's IP address. The easiest way is through Wi-Fi Settings:
<img src="/assets/images/fl3xbl0w/console-05.gif" alt="console animation" format="avif" />
...
Let's create an empty file inside `/sdcard/Pictures/` called `nautilus`. You can read more about "why" on [Bowflex Quirks](/projects/bl0wfl3x/quirks).
```sh
...
<img src="/assets/images/fl3xbl0w/console-06.gif" alt="console animation" format="avif" />


There's one final step - to change the default launcher. Search for "Default apps" and set Quickstep as the Home app:
<img src="/assets/images/fl3xbl0w/console-07.gif" alt="console animation" format="avif" />
...
<img src="/assets/images/fl3xbl0w/console-08.gif" alt="console animation" format="avif" />
