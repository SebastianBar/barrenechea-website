...
It is the documentation of the "Bowflex Console" (what Nautilus refers to as Vantron), which drives most of the "smart devices" from Bowflex (basically, an Android tablet running proprietary software), and also some hardware-related stuff that I got curious on.
...
After playing with the [decompiled apps](/projects/fl3xbl0w/decompiling) I can certainly say that the following documentation could be extrapolated in one way or another to the following Bowflex devices:
...
- [Android Jailbreak](/projects/fl3xbl0w/jailbreak)
- [Backup your Console contents](/projects/fl3xbl0w/backup)
- [Decompiling](/projects/fl3xbl0w/decompiling)
- [Bowflex Quirks](/projects/fl3xbl0w/quirks)

### Work in progress

- [Treadmill Motor Controller](/projects/fl3xbl0w/treadmotor)
- [ROM Dump](/projects/fl3xbl0w/romdump)
